...
// ─── HOME ───
function HomePage({ go, onAdd, heroVariant, cardVariant }) {
  return (
    <>
...
// ─── SHOP / CATEGORY ───
function ShopPage({ go, onAdd, cardVariant }) {
...
// ─── PRODUCT ───
function ProductPage({ id, go, onAdd, addPing }) {
...
Object.assign(window, { HomePage, ShopPage, ProductPage, AboutPage, GiftsPage });
